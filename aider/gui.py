...
class GUI:
    ...
    def do_knowledge_page(self):
        ...
        st.download_button(
            "Export Playbooks/Skills as Markdown",
            data=company.export_knowledge_markdown(),
            file_name="aider-plus-knowledge.md",
            mime="text/markdown",
            key="export_knowledge_markdown",
        )
                ...
                [
                    {
                        ...
                        "Last Used": skill.get("last_used_at") or "Never",
                    }
                    for skill in skills
                ],
                use_container_width=True,
                ...
                [
                    {
                        ...
                        "Last Used": proposal.get("last_used_at")

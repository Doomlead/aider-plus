...
def get_parser(default_config_files, git_root):
    ...
    group.add_argument(
        "--desktop-debug",
        action="store_true",
        help="Enable desktop web inspector/devtools (default: False)",
        default=False,
    )
    group.add_argument(
        "--skip-onboarding",
        action="store_true",
        help="Do not offer Company Mode onboarding on first run (default: False)",
        default=False,
    )
    group.add_argument(
        "--copy-paste",
    ...
    group.add_argument(
        "--adapter",
        choices=("discord", "slack", "webhook", "teams", "mattermost", "matrix"),
        action="append",
        default=[],
        help=(
